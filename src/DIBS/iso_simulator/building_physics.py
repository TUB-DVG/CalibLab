...
class Building(object):
    ...
    def __init__(self,
                 ...
                 heating_coefficient):  # CHANGED

        ## Dimensions
        self.heating_coefficient = heating_coefficient  # CHANGED
    ...
    def solve_building_energy(self, internal_gains, solar_gains, t_out, t_m_prev):
        ...
        if not self.has_heating_demand and not self.has_cooling_demand:
            ...
            if self.has_heating_demand:
                supply_director.set_builder(self.heating_supply_system(load=self.energy_demand*self.heating_coefficient, 
                                                                t_out=t_out, 
