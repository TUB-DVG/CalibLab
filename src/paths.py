...
DIBS_DATAPRE_DIR = str(os.path.join(PROJECT_DIR, 'src','DIBS_sim_modified','data_preprosessing'))
...
DIBS_DIR =  os.path.join(ROOT_DIR, 'DIBS_sim_modified')
AUX_DIR = os.path.join(ROOT_DIR, 'DIBS_sim_modified/iso_simulator/auxiliary')
